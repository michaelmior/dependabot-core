...
RSpec.describe Dependabot::Sbt::Requirement do
  ...
  describe ".new" do
    ...
    context "with a version that wouldn't be a valid Gem::Version" do
      ...
      it "creates a requirement object" do
        expect(requirement).to be_satisfied_by(
          Dependabot::Sbt::Version.new("Finchley.SR4")
        )
      end
    end
    ...
    context "with a requirement ending with build metadata" do
      ...
      it "creates a requirement object" do
        expect(requirement).to be_satisfied_by(
          Dependabot::Sbt::Version.new("1.0.0+92")
        )
      end
    end
    ...
    context "with a version that has underscores" do
      ...
      it "creates a requirement object" do
        expect(requirement).to be_satisfied_by(
          Dependabot::Sbt::Version.new("2.2.1_CODICE_1")
        )
      end
    end
  ...
  describe ".requirements_array" do
    ...
    context "with a comma-separated ruby style requirement with sbt versions" do
  ...
  describe "#satisfied_by?" do
    ...
    context "with a Sbt::Version" do
      let(:version) do
        Dependabot::Sbt::Version.new(version_string)
      end
